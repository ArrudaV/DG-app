...
export class ContractStatusService {
   ...
   */
  static async updateContractStatus(contractId: number): Promise<void> {
    ...
    let newStatus: 'ACTIVE' | 'EXPIRING' | 'EXPIRED';
   ...
   */
  static async updateAllContractStatuses(): Promise<void> {
   ...
   */
  static calculateContractStatus(expirationDate: Date | null): 'ACTIVE' | 'EXPIRING' | 'EXPIRED' | null {
    if (!expirationDate) {
      return null;
    }
