...
- [ ] Funciona com e sem banco de dados conectado
...
- VPC ID: `vpc-xxxxxxxx`
- Subnet pública 1: `subnet-xxxxxxxx` (us-east-1a)
- Subnet pública 2: `subnet-xxxxxxxx` (us-east-1b)
- Subnet privada 1: `subnet-xxxxxxxx` (us-east-1a)
- Subnet privada 2: `subnet-xxxxxxxx` (us-east-1b)
...
- **Endpoint:** `dg-mysql-db.xxxxx.us-east-1.rds.amazonaws.com`
- **Port:** `3306`
- **Username:** `admin`
- **Password:** `[SUA_SENHA]`
- **Database name:** `dg_contracts`
...
**📝 ANOTE ESTAS INFORMAÇÕES:**
- **Cluster ARN:** `arn:aws:ecs:REGION:ACCOUNT_ID:cluster/dg-cluster`
- **Task Definition ARN:** `arn:aws:ecs:REGION:ACCOUNT_ID:task-definition/dg-task:1`
- **Service ARN:** `arn:aws:ecs:REGION:ACCOUNT_ID:service/dg-cluster/dg-service`
- **Security Group ECS:** `sg-xxxxxxxx`
...
**📝 ANOTE ESTAS INFORMAÇÕES:**
- **ALB DNS Name:** `dg-alb-123456789.us-east-1.elb.amazonaws.com`
- **Target Group ARN:** `arn:aws:elasticloadbalancing:REGION:ACCOUNT_ID:targetgroup/dg-target-group/xxxxxxxx`
- **Certificate ARN:** `arn:aws:acm:REGION:ACCOUNT_ID:certificate/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx`
